...
RAIN_STATIONS_NATIONWIDE = {
    **RAIN_STATIONS_METRO_MANILA,
    ...
    "Palayan City": (15.5415, 121.0848),

    # Palawan
    "Puerto Princesa": (9.7392, 118.7353),

    # Mindoro
    "Calapan": (13.4115, 121.1803),          # Oriental Mindoro
    "San Jose, Occidental Mindoro": (12.3528, 121.0676),

    # Samar
    "Catbalogan": (11.7753, 124.8861),       # Samar
    "Borongan": (11.6089, 125.4317),         # Eastern Samar
    "Catarman": (12.4989, 124.6377),         # Northern Samar
}
...
FLOOD_PRONE_HINTS = {
    ...
    "Calapan": "Low-lying coastal and river-drainage areas",
    "San Jose, Occidental Mindoro": "Coastal and low-lying drainage-sensitive areas",
    "Puerto Princesa": "Localized urban drainage and coastal flooding",
    "Cabanatuan": "River and drainage-sensitive low-lying areas",
    "Palayan City": "Localized runoff and drainage-sensitive areas",
    "Catbalogan": "Coastal, tidal, and drainage-sensitive areas",
    "Borongan": "Coastal and river flood-sensitive areas",
    "Catarman": "River, coastal, and low-lying flood-sensitive areas",
}
...
if show_rain_layer and not rainfall_df.empty:
    failed_rainfall = rainfall_df[rainfall_df["total_window_mm"].isna()].copy()
    if not failed_rainfall.empty:
        with st.expander(f"Rainfall fetch errors ({len(failed_rainfall)} stations)"):
            st.dataframe(
                failed_rainfall[["area", "flood_prone_hint", "timestamp"]],
...
with left:
    ...
    map_center = DEFAULT_CENTER if rainfall_coverage == "Metro Manila" else [12.5, 122.0]
    map_zoom = 11 if rainfall_coverage == "Metro Manila" else 6
